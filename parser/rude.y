...
%%
program: start_function newline_list ENDPLS {printf("Parsing is successfully completed. We hope you are pleased with our language!"); return 1;}
	| start_function newline_list function_list newline_list ENDPLS {printf("Parsing is successfully completed. We hope you are pleased with our language!\n"); return 1;}
...
builtin_toggle_switch_off: FUNC_ID_SWITCH_OFF LP INTEGER RP
	| FUNC_ID_SWITCH_OFF LP IDENTIFIER RP
builtin_toggle_switch_on: FUNC_ID_SWITCH_ON LP INTEGER RP
	| FUNC_ID_SWITCH_ON LP IDENTIFIER RP
